...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(CallLuaTableByInterface.IWeaponTable), CallLuaTableByInterfaceIWeaponTableBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(CallLuaTableByInterfaceComp.IUserInfo), CallLuaTableByInterfaceCompIUserInfoBridge.__Create);
