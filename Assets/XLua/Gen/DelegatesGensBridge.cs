...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(int p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp2(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, int, int>(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(System.Func<int, int, int>))
			{
			    return new System.Func<int, int, int>(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(CSharpCallLua.AddMultiReturn))
			{
			    return new CSharpCallLua.AddMultiReturn(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(CSharpCallLua.AddMultiReturnRef))
			{
			    return new CSharpCallLua.AddMultiReturnRef(__Gen_Delegate_Imp14);
			}
